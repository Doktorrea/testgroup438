...
/*let arr = [1, "test", 3, 4, "two", 5];
function inArray(two, arr) {
	for (let i = 0; i < arr.length; i++) {
		if(arr[i] == two) {
			return true;
		}
...
alert(inArray("two", arr));*/ //выведет true
...
return newNum = newArr.join("");
}
alert("Сумма чисел " + isSimple(arr) + " равна однозначному числу");*/
...
/*let a = +prompt("Введите час:");
let b = +prompt("Введите минуты");
let c = ((a * 60 * 60) + (b * 60));
let d = ((a*60) + b);
let e = ((24*60)-d);
alert(`Данное время: ${a} часов ${b} минут, следовательно, ${c} секунд прошло с полуночи, ${d} минут прошло с полуночи и ${e} минут осталось до полуночи`);*/
